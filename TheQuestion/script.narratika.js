// opening tag for JS compatibility, ignore
;monogatari.script(Narratika.compile(`

// The game starts here.
@label start

    // Start by playing some music.
	@play music "music/illurock.opus" loop

    @scene bg_lecturehall with fade
    ...
    @scene bg_uni with fade

    ^ When we come out of the university, I spot her right away.

    @show sprite sylvie green_normal with fade
...
@label rightaway
    ...
    @show sprite sylvie green_smile
    ...
    @show sprite sylvie green_smile with dissolve
    ...
    @show sprite sylvie green_surprised
    ...
    @menu -> <s> Sure, but what's a "visual novel"?
        * It's a videogame. -> @jump game
        * It's an interactive book. -> @jump book
...
@label game
    ...
    @show sprite sylvie green_normal
...
@label marry
    ...
    @show sprite sylvie blue_normal with dissolve

    <s> Hey...

    <m> Yes?

    @show sprite sylvie blue_giggle

    <s> Will you marry me?

    <m> What? Where did this come from?

    @show sprite sylvie blue_surprised

    <s> Come on, how long have we been dating?

    <m> A while...

    @show sprite sylvie blue_smile
    ...
    @show sprite sylvie blue_normal
...
// closing tag for JS compatibility, ignore
`));